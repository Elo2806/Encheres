...
/**
 * 
 * Cette classe permet de centraliser les méthodes d'intéractions avec le système de persistance
 *
 * @author Catherine
...
public interface EnchereDAO {
	...
	/**
	 * 	
	 * Méthode permettant de créer une nouvelle enchère en base de données et de la mettre à jour
